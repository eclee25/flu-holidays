...
##args: (metropop, 0, 1)
	...
	if os.uname()[:2] == ('Linux', 'bansallab'):
		...
		datafile = csv.reader(open(filename, 'r'), delimiter = '\s')
...
if __name__ == "__main__":
	...
	print 'ran population_parameters'
	...
	# # print C_ij, C_ji, child, adult
	
	# # 8/13/15 ECL checks
	# calc_contact_matrix(filename_germ_contact_data, filename_germ_pop_data, 0.183)